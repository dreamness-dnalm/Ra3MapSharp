...
public class Symmetry5TwoPartsBackslashCenter: SymmetryStrategy
{
    public Symmetry5TwoPartsBackslashCenter(Ra3MapFacade sourceMapFacade, int templateAreaIndex) : base(sourceMapFacade, templateAreaIndex, 2)
    {
